      ...
      <section className="relative h-64 sm:h-80 md:h-96 overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center text-center px-4">
          <div className="max-w-3xl animate-fade-in-up">
            ...
            <p className="text-sm sm:text-base md:text-xl text-white/90 mb-4 sm:mb-8">
              Join thousands of learners building skills and finding meaningful careers
            </p>
            <div className="flex flex-wrap gap-3 sm:gap-4 justify-center">
              <div className="px-4 sm:px-6 py-2 sm:py-3 rounded-xl bg-white/10 backdrop-blur-md">
                <p className="text-xl sm:text-3xl font-bold text-white">9+</p>
                <p className="text-xs sm:text-sm text-white/80">Courses</p>
              </div>
              <div className="px-4 sm:px-6 py-2 sm:py-3 rounded-xl bg-white/10 backdrop-blur-md">
                <p className="text-xl sm:text-3xl font-bold text-white">50+</p>
                <p className="text-xs sm:text-sm text-white/80">Job Opportunities</p>
              </div>
              <div className="px-4 sm:px-6 py-2 sm:py-3 rounded-xl bg-white/10 backdrop-blur-md">
                <p className="text-xl sm:text-3xl font-bold text-white">100%</p>
                <p className="text-xs sm:text-sm text-white/80">Accessible</p>
              </div>
            </div>
          </div>
        </div>
